 ...
 * <p>
 * Description: from compile 'com.wuhenzhizao:titlebar:1.2.0'
 * </p>
 *
 * @author javakam
...
public class StatusBarUtils {
     ...
     */
    public static void setStatusBarView(Activity activity, @ColorRes int statusBarColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (count > 0) {
                ...
                View statusBarView;
                if (count > 1) {
                    statusBarView = (View) decorView.getChildAt(1);
                } else {
