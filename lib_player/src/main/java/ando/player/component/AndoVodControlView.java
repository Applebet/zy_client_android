 ...
 * @date 2020-03-29
 */
public class AndoVodControlView extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private boolean mIsShowFullScreenInNormal = true;


    public AndoVodControlView(@NonNull Context context) {
        super(context);
    }

    public AndoVodControlView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AndoVodControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected int getLayoutId() {
        return R.layout.layout_ando_player_vod_control_view;
    }
    ...
    public void attach(@NonNull ControlWrapper controlWrapper) {
        ...
        mFullScreen.setVisibility(mIsShowFullScreenInNormal ? VISIBLE : GONE);
    }
    ...
    public void setShowFullScreenInNormal(boolean mIsShowFullScreen) {
        this.mIsShowFullScreenInNormal = mIsShowFullScreen;
    }
}
